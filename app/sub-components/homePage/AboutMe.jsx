          ...
          >
            <div className="flex-1 flex flex-col p-8 font-bai">
              <Image
                ...
                alt=""
              />
              <h3 className="mt-6 text-pri text-sm font-medium ">
                {person.name}
              </h3>
              <dl className="mt-1 flex-grow flex flex-col justify-between">
                <dt className="sr-only">Title</dt>
                <dd className="text-sec text-sm">{person.title}</dd>
                <dt className="sr-only">Role</dt>
                <dd className="mt-3">
                  <span className="px-3 py-1 text-sec text-xs font-medium bg-black/70  rounded-full">
                    {person.role}
                  </span>
                </dd>
              </dl>
